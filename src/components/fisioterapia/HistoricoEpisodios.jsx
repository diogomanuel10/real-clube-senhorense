                ...
                <div className="space-y-3">
                    {episodios.map((ep) => {
                        ...
                        return (
                            <div
                                key={ep.id}
                                className={`border rounded-xl p-4 ${isAtivo ? 'border-red-200 bg-red-50' : 'border-gray-200 bg-gray-50'
                                    }`}
                            >
                                <div className="flex items-start justify-between gap-3">
                                    ...
                                    <span
                                        className={`inline-flex px-2.5 py-1 rounded-full text-xs font-semibold whitespace-nowrap ${isAtivo
