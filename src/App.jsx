    ...
    <Routes>
      ...
      {user ? (
        <>
          ...
          <Route path="/atletas" element={<DashboardLayout user={user}><Atletas user={user} /></DashboardLayout>} />
          <Route path="/avaliacoes" element={<DashboardLayout user={user}><Avaliacoes user={user} /></DashboardLayout>} />
          ...
          <Route path="/comunicados" element={<DashboardLayout user={user}><Comunicados user={user} /></DashboardLayout>} />
          <Route path="/exercicios" element={<DashboardLayout user={user}><Exercicios user={user} /></DashboardLayout>} />
          <Route path="/firebase-monitoring" element={<DashboardLayout user={user}><FirebaseMonitoring user={user} /></DashboardLayout>} />
  ...
  if (loading) {
    return (
      <div className="flex h-screen w-full items-center justify-center">
        <img src="/logo.png" alt="Real Clube Senhorense" className="h-20 w-20 animate-bounce" />
      </div>
    );
  }
