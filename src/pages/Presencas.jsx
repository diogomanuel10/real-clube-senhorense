...
export default function Presencas({ user }) {
  ...
  const carregarDadosEscalao = async () => {
    ...
    if (
      ...
      !permissions.equipas.includes(escalaoSelecionado)
    ) {
    ...
    try {
      ...
      const atletasEscalao = todosAtletas.filter(
        (a) => a.equipa === escalaoSelecionado,
      );
      setAtletas(atletasEscalao);

      const ultimoDia = new Date(currentYear, currentMonth + 1, 0);
      const dataInicio = `${currentYear}-${String(
        currentMonth + 1,
      ).padStart(2, "0")}-01`;
      const dataFim = `${currentYear}-${String(
        currentMonth + 1,
      ...
      if (treinosEscalao.length > 0) {
        ...
        const presencasEscalao = todasPresencas.filter((p) =>
          treinoIds.includes(p.treinoId),
        );
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 pb-8">
        ...
        <div className="flex flex-col sm:flex-row flex-wrap gap-4">
          ...
          <div className="flex-1 min-w-[240px]">
            ...
            <div className="flex items-center gap-2">
              ...
              <div className="flex-1 text-center font-semibold text-slate-900 text-sm">
      ...
      {loading ? (
        ...
        <>
          ...
          {/* Atletas – tabela desktop + cards mobile */}
          <div className="bg-white rounded-xl border border-slate-200 overflow-hidden">
            ...
            {atletas.length === 0 ? (
              ...
              <div className="p-8 text-center">
                ...
                <p className="text-slate-500">
                  Nenhum treino marcado este mês
                </p>
              </div>
            ) : (
              <>
                        ...
                        >
                          ...
                          <td className="px-4 py-4 text-center">
                            <div className="flex items-center justify-center gap-2">
                              <span
                                className={`px-3 py-1 rounded-full text-sm font-bold ${getCorPercentagem(
                  ...
                  {atletasOrdenados.map((atleta, index) => (
                    ...
                    >
                      ...
                      <div className="flex items-center justify-between mt-1">
                        <div className="flex items-center gap-2">
                          <span
                            className={`px-3 py-1 rounded-full text-xs font-bold ${getCorPercentagem(
                              atleta.stats.percentagem,
                            )}`}
                          >
                            {atleta.stats.percentagem}%
