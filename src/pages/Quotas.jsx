...
export default function Quotas() {
  ...
  const handleEliminarQuota = async (quota) => {
    if (
      !confirm(
        `Tens a certeza que queres eliminar a quota de ${quota.atletaNome}?`,
      )
    )
      return;
  ...
  return (
    <div className="min-h-screen bg-slate-900 px-4 sm:px-6 py-6">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4 mb-6">
          <div>
            ...
            <p className="text-sm sm:text-base text-slate-300">
              Gestão de quotas mensais dos atletas
            </p>
          </div>
          <div className="flex flex-wrap gap-2 sm:gap-3">
            <input
              ...
              className="bg-slate-800 text-white px-3 sm:px-4 py-2 rounded-lg border border-slate-700 focus:border-blue-500 focus:outline-none text-sm"
            />
            <button
              onClick={handleExportar}
              disabled={quotasFiltradas.length === 0}
              className="bg-emerald-600 hover:bg-emerald-700 disabled:bg-slate-700 disabled:cursor-not-allowed text-white px-3 sm:px-4 py-2 rounded-lg flex items-center gap-2 text-sm transition-colors"
            >
              <FaDownload />
              Exportar
            </button>
            <button
              ...
              className="bg-blue-600 hover:bg-blue-700 text-white px-4 sm:px-6 py-2 rounded-lg flex items-center gap-2 text-sm sm:text-base transition-colors"
            >
              <FaPlus />
              Nova Quota
            </button>
